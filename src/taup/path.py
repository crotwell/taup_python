...
# For The TauP Toolkit, version: 3.2.2-SNAPSHOT_2026-09-12T151622

from .dataclass import TimeResult
...
class PathQuery:
  ...
  def get_ellipticity(self):
    """
    returns current value of ellipticity as a Boolean
    """
    return self._ellipticity

  def ellipticity(self, val=True):
    """
    ...
    Known as ``--ellipticity`` in command line.

    :param val: value to set ellipticity to
    """
    self._ellipticity = val
    return self

  def get_equitorialradius(self):
    """
    returns current value of equitorialradius as a Double
    """
    return self._equitorialradius

  def equitorialradius(self, val):
    """
    ...
    :param val: value to set equitorialradius to
    """
    self._equitorialradius = val
    return self
  ...
  def get_planet(self):
    """
    returns current value of planet as a edu.sc.seis.TauP.DistAzPlanet
    """
    return self._planet

  def planet(self, val):
    """
    Sets the planet parameter, a choice of one of:
     EARTH, MOON, MARS, VENUS, MERCURY, CERES, JUPITER, SATURN, URANUS, NEPTUNE, PLUTO

    Geodesic for planets, for distance calculations when --geodetic, one of: EARTH, MOON, MARS, VENUS, MERCURY, CERES, JUPITER, SATURN, URANUS, NEPTUNE, PLUTO.

    Known as ``--planet`` in command line.

    :param val: value to set planet to
    """
    self._planet = val
    return self
  ...
  def get_seconds(self):
    """
    returns current value of seconds as a List
    """
    return self._seconds

  def seconds(self, val):
    """
    Sets the seconds parameter, of type List of Double
    If a single Double is passed in, it is automatically wrapped in a list. So
    ...
    Known as ``--seconds`` in command line.

    :param val: value to set seconds to
    """
    if not hasattr(val, "__getitem__"):
      val = [ val ]
    self._seconds = val
  ...
  def andSeconds(self, val):
    """
    Append a value to the seconds parameter,  of type Double
  ...
  def get_siderealday(self):
    """
    returns current value of siderealday as a Double
    """
    return self._siderealday

  def siderealday(self, val):
    """
    Sets the siderealday parameter, of type Double

    Sidereal length of day for ellipticity correction, in seconds, defaults to Earth value of 86164.0905

    Known as ``--siderealday`` in command line.

    :param val: value to set siderealday to
    """
    self._siderealday = val
    return self
  ...
  def get_withlatlon(self):
    """
    returns current value of withlatlon as a Boolean
    """
  ...
  def withlatlon(self, val=True):
    ...
    Known as ``--withlatlon`` in command line.

    :param val: value to set withlatlon to
    """
    self._withlatlon = val
    return self
  ...
  def create_params(self):
    ...
    if self._ellipticity is not None:
      params["ellipticity"] = self._ellipticity
    ...
    if self._siderealday is not None:
      params["siderealday"] = self._siderealday
    ...
    if self._withlatlon is not None:
      params["withlatlon"] = self._withlatlon
