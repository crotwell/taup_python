...
class PathQuery:
  ...
  def planet(self, val):
    ...
    Sets the planet parameter, a choice of one of:
     EARTH, MOON, MARS, VENUS, MERCURY, CERES, JUPITER, SATURN, URANUS, NEPTUNE

    Geodesic for planets, for distance calculations when --geodetic, one of: EARTH, MOON, MARS, VENUS, MERCURY, CERES, JUPITER, SATURN, URANUS, NEPTUNE.
