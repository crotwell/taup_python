...
from .dataclass import CurveResult
...
class CurveQuery:
  ...
  def x(self, val):
    ...
    Sets the xaxis parameter, a choice of one of:
     radian, radian180, degree, degree180, kilometer, kilometer180, rayparamrad, rayparamdeg, rayparamkm, time, tau, takeoffangle, incidentangle, maxdepth, dpddelta, dpddeg, dtakeoffddeg, dincidentddeg, amp, amppsv, ampsh, phase, phasepsv, phasesh, phasedeg, phasedegpsv, phasedegsh, unwrapphasedeg, unwrapphasedegpsv, unwrapphasedegsh, geospread, refltran, refltranpsv, refltransh, index, tstar, attenuation, energygeospread, pathlength, radiation, radiationpsv, radiationsh, intcaustic
